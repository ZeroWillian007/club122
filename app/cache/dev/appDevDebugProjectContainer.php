...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'club122db', 'user' => 'willianleonidas', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/WBJ/UserBundle/Resources/config/doctrine') => 'WBJ\\UserBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'WBJ\\UserBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('WBJUserBundle' => 'WBJ\\UserBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/WBJ/UserBundle/Resources/views'), 'WBJUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a9379d425a714c50b49c677e2583b05ac5ad3ce1');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58f3a4e8bca6a3.27914943')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WBJUserBundle' => 'WBJ\\UserBundle\\WBJUserBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'club122db',
            'database_user' => 'willianleonidas',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'a9379d425a714c50b49c677e2583b05ac5ad3ce1',
            'locale' => 'en',
            'brochures_directory' => ($this->targetDirs[2].'/../web/uploads/fotos'),
            ...
            'kernel.secret' => 'a9379d425a714c50b49c677e2583b05ac5ad3ce1',
            ...
            'assetic.node.bin' => ($this->targetDirs[4].'/.nvm/versions/node/v4.7.3/bin/node'),
